...
_Static_assert((BFL_DATA0_BASE % FLASH_ERASE_SIZE) == 0U, "BFL_DATA0 must be sector aligned");
_Static_assert((BFL_DATA1_BASE % FLASH_ERASE_SIZE) == 0U, "BFL_DATA1 must be sector aligned");
